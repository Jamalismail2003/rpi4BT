...
#define HID_CTRL_PSM  	0x0011 // This channel is used for control-related messages like setting protocol modes
#define HID_INTR_PSM    0x0013 // This channel is used for sending the actual HID reports, such as key presses or mouse movements.
...
typedef struct lcap_data_header lcap_data_header;
...
typedef struct lcap_command_header lcap_command_header;
...
typedef struct lcap_data_packet_header lcap_data_packet_header;
...
typedef struct lcap_command_packet_header lcap_command_packet_header;
...
typedef struct lcap_connect_request lcap_connect_request;
...
typedef struct lcap_connect_response lcap_connect_response;
...
typedef struct lcap_config_request lcap_config_request;
...
typedef struct lcap_config_response lcap_config_response;
...
typedef struct lcap_info_request lcap_info_request;
...
typedef struct lcap_info_response_features lcap_info_response_features;
...
typedef struct lcap_info_response_fixed_channels lcap_info_response_fixed_channels;
...
typedef struct lcap_command_reject lcap_command_reject;
...
typedef struct lcap_disconnect_request lcap_disconnect_request;
